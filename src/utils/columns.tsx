...
export const engajamentoColumns = [
  {
    label: "Aluno",
    name: "nome",
    options: {
...
// colunas para Desempenho
export const desempenhoColumns = [
  {
    label: "Aluno",
    name: "nome",
    options: {
...
// colunas para Motivação
export const motivacaoColumns = [
  {
    label: "Aluno",
    name: "nome",
    options: {
...
// colunas para Relação Aluno-Professor
export const relacaoAlunoProfColumns = [
  {
    label: "Aluno",
    name: "nome",
    options: {
...
// colunas para Desistência
export const desistenciaColumns = [
  {
    label: "Aluno",
    name: "nome",
    options: {
...
export const getColumns = (activeTab: string) => {
  switch (activeTab) {
    case "Engajamento":
